...
public class CrimeLab {
    ...
    //Metodo para eliminar crimen (por parametro se pasa el numero del crimen en el ViewPager)
    public void deleteCrime (int numberCrime){
        //Extreamos el UUID del crimen en la posicion dentro de nuestra lista de crimenes
        UUID idToDelete = getCrimes().get(numberCrime).getId();
        //Realizamos la consulta para eliminar el susodicho crimen
        mDatabase.delete(CrimeTable.NAME,CrimeTable.Cols.UUID + " = ?",
                new String[] {idToDelete.toString()});
    }
